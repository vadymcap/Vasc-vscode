...
const SETTINGS = [
  ...
  },
  {
    field: "run_async",
    value: "${1|false,true|}",
    doc: "Run Vasc asynchronously, freeing up the terminal",
  },
  {
    field: "scan_ports",
    value: "${1|true,false|}",
  ...
  },
  {
    field: "check_updates",
    value: "${1|true,false|}",
    doc: "Check for new Vasc releases on startup",
  },
  {
    field: "auto_update",
    value: "${1|false,true|}",
    doc: "Automatically install Vasc updates if available",
  },
  {
  ...
  },
  {
    field: "share_stats",
    value: "${1|true,false|}",
    doc: "Share anonymous Vasc usage statistics with the community",
  },
]
